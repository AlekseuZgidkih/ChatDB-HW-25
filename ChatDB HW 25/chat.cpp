...
bool ChatManager::sendMessage(const std::string& senderFirstName, const std::string& receiverFirstName, const std::string& messageText) {
    DatabaseManager dbManager;
    if (dbManager.connectToDatabase()) {
        // Ïîëó÷åíèå èäåíòèôèêàòîðà îòïðàâèòåëÿ
        ...
        // Ïîëó÷åíèå èäåíòèôèêàòîðà ïîëó÷àòåëÿ
        ...
        // Âñòàâêà ñîîáùåíèÿ â òàáëèöó messages
...
void userMenu(const std::string& username) {
    ...
    do {
        ...
        case 1: {
            ...
            std::cin.ignore(); // ×òîáû ïðîïóñòèòü ñèìâîë íîâîé ñòðîêè ïîñëå ïðåäûäóùåãî ââîäà
